...
Cfg : {
   ...
   DefaultsVersion:"110001",
   AutoVersion:"1", SuppressCfg:"0", DefaultCfg:"3", DefaultCfgMenu:"1",

   Editing:"1", Adding:"1", Deleting:"1",	ShowDeleted:"1", Copying:"1", Resizing:"1", Selecting:"1", SelectingCells:"0", DynamicSpan:"0", EditSelect:"3",
...
Actions : {
   ...
   OnCtrlClickCell:"DeselectCell OR SelectCell OR DeselectRow OR SelectRow,1",
   ...
   EdgeSize:"5", RowSize:"5", GanttSize:"5", GanttSizeOnly:"10", DragSize:"5", ClickSize:"5", GridSize:"20", GanttSizeOver:"0", ScrollColSize:"10",
   EdgeSizeTouch:"20", RowSizeTouch:"10", GanttSizeTouch:"10", GanttSizeOnlyTouch:"1000", DragSizeTouch:"5", ClickSizeTouch:"20", GridSizeTouch:"40", GanttSizeOverTouch:"3", GanttSizeOverTouchFocused:"10", ScrollColSizeTouch:"20"
   },
...
Def: {
   ...
   R : { 
      ...
      CanFocus:"1", CanEdit:"1", CanDelete:"1", CanSelect:"1", CanResize:"1",
   ...
   Solid: {
      ...
      Visible:"1",
      CalcOrder:"",
      CanFocus:"1", CanDelete:"0", CanSelect:"0", CanDrag:"0", CanFilter:"0", CanCopy:"0", CanPrint:"1", CanResize:"1",
      AcceptDef:"",
...
DefCols: {
   ...
   Gantt: { 
      ...
      CanSort:"0", CanEdit:"0", CanResize:"0", CanFilter:"0", CanCopyPaste:"0", CanGroup:"0", CanSearch:"0", WidthPad:"", ShowHint:"0", CanDrag:"0", NoUpload:"1",
      ...
      GanttRunResize:"Resize", GanttRunMove:"Slide", GanttRunAdjust:"Shift", GanttRunAdjustStart:"Slip", GanttRunAdjustCorrect:"Slip", GanttRunError:"Sort", GanttRunErrors:"1", GanttRunJoined:"0", GanttRunJoinedNbsp:"255", GanttRunSelect:"0", GanttRunTip:"*Text*", GanttRunBoxMinType:"1",
      GanttRunNew:"0.0001,Box", GanttRunNewStart:"0.0001,Box", GanttRunGroupHover:"1", GanttRunStates:"2", GanttRunCorrectFixed:"1", GanttRunMilestones:"1", GanttRunIds:"1", GanttRunIdPrefix:"new", GanttRunIdPostfix:"", GanttRunLastId:"", GanttRunDragObject:"2",
      GanttMenu:"SplitGanttConstraint,ChangeGanttConstraint,EditGanttFlag,ChooseGanttFlagIcon,SetGanttMilestone,LockGanttMain,DisableGanttMain,SplitGanttMain,SetGanttPercent,EditGanttPercent,EditGanttText,SelectGanttRunPart,LockGanttRun,DisableGanttRun,SplitGanttRun,EditGanttRun,EditGanttRunTip,ChooseGanttRunType,-,SelectGanttRun,UnselectGanttRun,JoinGanttRunSelected,SplitGanttRunJoined,JoinGanttRunAdjacent,SplitGanttRunAdjacent,ChooseGanttRunSelectedType,ChooseGanttRunGroupType,ChooseGanttRunGroupAllType,ChooseGanttRunRowType,-,SetGanttRunMilestone,SetGanttRunPercent,EditGanttRunPercent,EditGanttRunText,-,EditGanttResource,GanttDepLagChange,-,DelGanttDep,DelGanttConstraint,DelGanttFlag,DelGanttPoint,DelGanttMilestone,DelGanttMainPart,DelGanttMain,DelGanttRunPart,-,DelAllGanttDep,DelGanttMainAll,DelGanttMainBar,DelGanttRunSelected,DelGanttRunGroup,DelGanttRunGroupAll,DelGanttRun,DelGanttFlags,DelGanttPoints,DelGanttConstraints,DelGanttAll,-,NewGanttFlag,NewGanttPoint,NewGanttConstraint,NewGanttMilestone,NewGanttEndMilestone,NewGanttRunStop,-,SetGanttBase,DelGanttBase,SetGanttFinish,DelGanttFinish,CorrectRelatedDependencies,CorrectAllDependencies,-,ZoomBar,ZoomAll,ZoomHeader,ZoomUndo,ZoomIn,ZoomOut,ZoomFit"
      }
...
Panel : {
   ...
   CanHide:"1", CanResize:"0", CanMove:"0", CanDrag:"1", CanExport:"0", CanCopyPaste:"0", CanSelect:"0", CanPrint:"0", NoUpload:"1",
...
Toolbar : {
   ...
   ExportPDFButton:"Class", ExportPDFOnEnter:"ExportPDF", ExportPDFVisibleFormula:"!!Grid.Source.ExportPDF.Url",
   ExportButton:"Class", ExportOnEnter:"Export", ExportVisibleFormula:"!!Grid.Source.Export.Url",
   ...
   AddButton:"Class", AddOnEnter:"CopyMenuF OR AddRowF OR AddRowEnd", AddVisibleFormula:"Grid.Adding",
   ...
   AddChildButton:"Class", AddChildOnEnter:"CopyMenuF OR AddChildEndF", AddChildVisibleFormula:"Grid.Adding && !!Grid.MainCol",
   AddChildCopyMenu:"CopySelectedChildEnd,CopySelectedTreeChildEnd,CopySelectedEmptyChildEnd,AddChildEnd",
   JoinButton:"Class", JoinOnEnter:"SpanSelected", JoinVisibleFormula:"Grid.SelectingCells && Grid.DynamicSpan",
   SplitButton:"Class", SplitOnEnter:"SplitSelected OR SplitCellF", SplitVisibleFormula:"Grid.SelectingCells && Grid.DynamicSpan",
   OutdentButton:"Class", OutdentOnEnter:"OutdentSelected OR OutdentF", OutdentVisibleFormula:"!!Grid.MainCol && !!Grid.Dragging",
   IndentButton:"Class", IndentOnEnter:"IndentSelected OR IndentF", IndentVisibleFormula:"!!Grid.MainCol && !!Grid.Dragging",
   ...
   StyleComboSwitch:"1", StyleComboList:"Standard,Light,Office,Modern,Borders,Query,ExtJS,Round,Plain,Colors", StyleComboPopupIcon:"2", StyleComboVisibleFormula:"Row.Styles==2",
   StyleComboFormula:"var S={GS:'Standard',GL:'Light',GO:'Office',GM:'Modern',GB:'Borders',GQ:'Query',GE:'ExtJS',GR:'Round',GP:'Plain',GC:'Colors'}[Grid.Style];return S?S:Grid.Style",
   StyleComboOnChange:"Grid.SetStyle({Standard:'GS',Light:'GL',Office:'GO',Modern:'GM',Borders:'GB',Query:'GQ',ExtJS:'GE',Round:'GR',Plain:'GP',Colors:'GC'}[Value],Value,1)",

   StyleStandardButtonText:"Standard", StyleStandardSwitch:"1", StyleStandardVisibleFormula:"Row.Styles==1",
   ...
   StyleLightButtonText:"Light", StyleLightSwitch:"1", StyleLightVisibleFormula:"Row.Styles==1",
   ...
   StyleOfficeButtonText:"Office", StyleOfficeSwitch:"1", StyleOfficeVisibleFormula:"Row.Styles==1",
   ...
   StyleModernButtonText:"Modern", StyleModernSwitch:"1", StyleModernVisibleFormula:"Row.Styles==1",
   ...
   StyleBordersButtonText:"Borders", StyleBordersSwitch:"1", StyleBordersVisibleFormula:"Row.Styles==1",
   ...
   StyleQueryButtonText:"Query", StyleQuerySwitch:"1", StyleQueryVisibleFormula:"Row.Styles==1",
   ...
   StyleExtJSButtonText:"ExtJS", StyleExtJSSwitch:"1", StyleExtJSVisibleFormula:"Row.Styles==1",
   ...
   StyleRoundButtonText:"Round", StyleRoundSwitch:"1", StyleRoundVisibleFormula:"Row.Styles==1",
   StyleRoundFormula:"Grid.Style=='GR'", StyleRoundOnClick:"Grid.SetStyle('GR','Round',1);return 1", StyleRoundOnEnter:"Grid.SetStyle('GR','Round',1)",
   StylePlainButtonText:"Plain", StylePlainSwitch:"1", StylePlainVisibleFormula:"Row.Styles==1",
   ...
   StyleColorsButtonText:"Colors", StyleColorsSwitch:"1", StyleColorsVisibleFormula:"Row.Styles==1",
   ...
   ResizeWidth:"9", ResizeType:"Html", ResizeVisibleFormula:"!!Grid.ResizingMain", ResizeCanFocus:"0", ResizeVAlign:"", 
   Tag:"", Visible:"1"
   },
...
MenuCfg : {
   Items:"GanttCheckDependencies,GanttCheckExclude,GanttCheck,GanttCorrectDependencies,GanttDirection,GanttStrict,GanttCorrectDependenciesFixed,GanttFixComplete,GanttCorrectOutsideBounds,GanttBaseProof,GanttFinishProof,GanttBasePreferred,GanttFinishPreferred,GanttMinSlack,GanttErrSlack,GanttSeparateSlack,GanttHideExclude,GanttSeparator1,ShowDeleted,ReversedTree,AutoSort,SortClick,AutoUpdate,CheckUpdates,Separator1,Scrollbars,Scroll,MouseHover,ShowDrag,ShowPanel,ShowPager,ShowAllPages,ShowButtons"
   }
